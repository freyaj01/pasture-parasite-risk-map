  ...
  return (
     ...
     <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        <aside className="w-[320px] bg-white border-r p-6" >
          <h2 className="text-xl font-semibold mb-4 dark:text-black">How to use this map</h2>
   ...
   <div className="w-full h-full">
      <MapPage />
          ...
          <div className="absolute top-6 right-6 bg-white shadow rounded p-4 z-100">
            <h3 className="text-sm font-bold mb-3 dark:text-black">Risk Level ↑</h3>
            <div className="space-y-1 text-sm">
              <div className="text-red-600 mt-1 font-semibold">High </div>
                <div className="text-yellow-400 mt-1 font-semibold ">Medium </div>
                     <div className="text-green-400 mt-1 font-semibold ">Low </div>
      ...
      <div className="bg-white border-t">
        <details className="p-4 border-b">
          <summary className="cursor-pointer font-medium dark:text-black">
        ...
        <details className="p-4">
          <summary className="cursor-pointer font-medium dark:text-black">
            ...
            <div className="p-6 bg-gray-100 rounded mt-4">
                <p className="mb-5 text-gray-txt dark:text-black">Have questions, suggestions, or just want to say hello? We'd love to hear from you! Drop us a message and we'll get back to you as soon as possible.</p>
                <p></p>
                <div className="relative mb-4">
                    <label htmlFor="name" className="leading-7 text-sm text-gray-dark onclick-blue dark:text-black ">Name</label>
               ...
               focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition dark:text-black" required/>
                </div>
                <div className="relative mb-4"> 
                    <label htmlFor="email" className="leading-7 text-sm text-gray-dark dark:text-black">Email</label>
               ...
               focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition dark:text-black" required/>
                ...
                <div className="relative mb-4">
                    <label htmlFor="message" className="leading-7 text-sm text-gray-dark dark:text-black">Message</label>
